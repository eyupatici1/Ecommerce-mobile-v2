...
import com.example.bitirme.adapters.ShowAllAdapter;
...
public class ShowAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(type != null && type.equalsIgnoreCase("drink")) {
            ...
            firestore.collection("ShowAll").whereEqualTo("type", "drink")
                    .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if(type != null && type.equalsIgnoreCase("clothes")) {
            ...
            firestore.collection("ShowAll").whereEqualTo("type", "clothes")
                    .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
        ...
        if(type != null && type.equalsIgnoreCase("other")) {
            ...
            firestore.collection("ShowAll").whereEqualTo("type", "other")
                    .get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                        @Override
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
